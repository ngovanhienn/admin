...
// import { getDatabase, get,update, remove, onValue } from 'firebase/database';
...
const Product = () => {
    ...
    const updateProduct = async (productId) => {
        try {
            ...
            // const productRef = onValue(db, 'Product', productId);
    ...
    const removeProduct = async (productId) => {
        try {
            ...
            // await remove(onValue(db, 'Product', productId));
                        ...
                        {product.map((products) => (
                            <div key={products.id}>
                                <div className={stylepro.containerview}>
                                    ...
                                    >
                                        <button onClick={() => removeProduct(products.id)}>
                                            <span>xóa</span>
                                        </button>
